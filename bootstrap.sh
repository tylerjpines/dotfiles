...
echo "     - Import your SSH key into 1Password vault"
echo "     - Then delete plaintext key: rm ~/.ssh/id_ed25519 ~/.ssh/id_ed25519.pub"
echo "  3. Set machine-local secrets in ~/.zshrc.local (e.g. RC_PRIVATE_KEY)"
echo "  4. Install mise runtimes: mise install"
echo ""
